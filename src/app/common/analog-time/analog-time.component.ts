...
import { ChangeDetectionStrategy, NgZone, ViewChild, Input, ElementRef } from "@angular/core";
...
export class AnalogTimeComponent implements OnInit, OnDestroy, AfterViewInit {
